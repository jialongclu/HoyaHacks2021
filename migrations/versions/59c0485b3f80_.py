...
Revision ID: 59c0485b3f80
Revises: cecba96105ad
Create Date: 2021-01-30 20:25:15.253599
...
revision = '59c0485b3f80'
down_revision = 'cecba96105ad'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('credibilityScore', sa.Float(), nullable=True),
